...
from xblock_problem.capa.safe_exec import safe_exec, update_hash
from xblock_problem.capa.safe_exec.remote_exec import is_codejail_in_darklaunch, is_codejail_rest_service_enabled
from xblock_problem.capa.safe_exec.safe_exec import emsg_normalizers, normalize_error_message
...
class TestSafeOrNot(unittest.TestCase):
    ...
    def test_cant_do_something_forbidden(self):
        ...
        properly configured. In xblocks-core, the test **will pass**
        ...
        * in-platform setup:
        https://github.com/openedx/xblocks-core/blob/main/src/xblock_problem/capa/safe_exec/README.rst
...
class TestCodeJailDarkLaunch(unittest.TestCase):
    ...
    @patch("xblock_problem.capa.safe_exec.safe_exec.get_remote_exec")
    @patch("xblock_problem.capa.safe_exec.safe_exec.codejail_safe_exec")
    ...
    def run_dark_launch(  # pylint: disable=too-many-positional-arguments,too-many-arguments
        ...
        with (
            patch("xblock_problem.capa.safe_exec.safe_exec.codejail_safe_exec") as mock_local_exec,
            patch("xblock_problem.capa.safe_exec.safe_exec.get_remote_exec") as mock_remote_exec,
            patch("xblock_problem.capa.safe_exec.safe_exec.set_custom_attribute") as mock_set_custom_attribute,
            patch("xblock_problem.capa.safe_exec.safe_exec.log.info") as mock_log_info,
        ):
    ...
    @patch("xblock_problem.capa.safe_exec.safe_exec.record_exception")
    @patch("xblock_problem.capa.safe_exec.safe_exec.log.error")
