...
from xblock_problem.capa.tests.helpers import load_fixture, mock_capa_system, new_loncapa_problem
...
from xblock_problem.capa.util import convert_files_to_filenames
from xblock_problem.capa.xqueue_interface import DATEFORMAT
...
class NumericalResponseTest(ResponseTest):
    ...
    def test_grade_infinity(self):
        ...
        with mock.patch("xblock_problem.capa.responsetypes.evaluator") as mock_eval:
